...
{
    subscriptionManager: SubscriptionManager<MessageOutletComponent>; 
    ...
    {
        this.subscriptionManager = new SubscriptionManager<MessageOutletComponent>(this,messageSubscriptions);
    }
