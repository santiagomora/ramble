...
int Open_conection ( struct sockaddr_in * my_addr)
{
	...
	/* Con la estructura sockaddr_in completa, se declara 
	 * en el Sistema que este proceso escuchará pedidos 
	 * por la IP y el port definidos
	 * */
	 ...
	 * con una cola de conexiones en espera que tendrá 
