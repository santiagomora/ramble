...
function preformat(usarr) {
  ...
  for (let k = 0; k < usarr.length; k++) {
    ...
    res.push(el);
    if (check > 0)
    [res, read, k] = findsin(usarr, res, multi[check], k);else
    if (check === 0)
...
class MarkdownPreview extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/(
      ...
      React.createElement("div", { style: { paddingLeft: "0px" }, className:
        state.expand === "ed" ?
        "col-md-8 mbottom" :
        state.expand === "pv" ?
        "col-md-4 mbottom" :
        "col-md-5 mbottom" }, /*#__PURE__*/
      React.createElement("p", null, "Enter the text you wish to markdown in the editor."), /*#__PURE__*/


      React.createElement("div", { className: "textarea", style: { paddingTop: "1px" } }, /*#__PURE__*/
      React.createElement("div", { className: "smpadding smargin sub" }, /*#__PURE__*/
      React.createElement("div", { className: "inblock spadding", style: { width: "70%" } }, /*#__PURE__*/
      React.createElement("strong", null, "Editor")), /*#__PURE__*/

      React.createElement("div", { className: "inblock text-right", style: { width: "30%" } }, /*#__PURE__*/
      React.createElement("button", { className: "noborder transparent smpadding nomargin sfont", id: "ed", onClick: this.expand }, /*#__PURE__*/
      React.createElement("p", { className: "buttontext nopadding nomargin sfont" }, /*#__PURE__*/
      React.createElement("i", { className:
        state.expand === "ed" ?
        "fas fa-compress-arrows-alt" :
        "fas fa-expand-arrows-alt" }))))), /*#__PURE__*/





      React.createElement("textarea", { id: "editor", className: "textarea mpadding", rows: "12", onChange: this.format, value: state.text }))), /*#__PURE__*/
      ...
      React.createElement("div", { className:
        ...
        state.expand === "ed" ?
        "col-md-4" :
        "col-md-7", style: { overflowY: "auto" } }, /*#__PURE__*/
      React.createElement("div", { className: "sub smpadding" }, /*#__PURE__*/
      React.createElement("div", { className: "mid inblock" }, /*#__PURE__*/
      React.createElement("p", { className: "nomargin" }, /*#__PURE__*/React.createElement("strong", null, "Preview"))), /*#__PURE__*/

      React.createElement("div", { className: "inblock mid text-right" }, /*#__PURE__*/
      React.createElement("button", { className: "noborder transparent smpadding nomargin sfont", id: "pv", onClick: this.expand }, /*#__PURE__*/
      React.createElement("p", { className: "buttontext nopadding nomargin sfont" }, /*#__PURE__*/
      React.createElement("i", { className:
        state.expand === "pv" ?
        "fas fa-compress-arrows-alt" :
      ...
      React.createElement("div", { id: "preview", className: "mpadding limitheight" }, state.mark))), /*#__PURE__*/


      React.createElement("div", { className: "row justify-content-end stpadding" }, /*#__PURE__*/
      React.createElement("button", { className: "transparent smpadding nomargin", style: { verticalAlign: "middle" } }, /*#__PURE__*/
      React.createElement("p", { className: "buttontext nopadding nomargin", onClick: this.clear }, "clear text box")))));
