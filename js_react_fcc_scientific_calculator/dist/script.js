function _extends() {_extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};return _extends.apply(this, arguments);}const sets = {
  '48': {
    key: '0',
    code: 48,
    id: "zero",
...
function Button(props) {
  return /*#__PURE__*/(
    ...
    React.createElement("button", {
      ...
      "dial inblock margin" }, /*#__PURE__*/

    React.createElement("strong", null, props.num.key))));
...
function Panel(props) {
  return /*#__PURE__*/(
    ...
    props.elems.map(
    (e, i) => /*#__PURE__*/
    React.createElement("div", { className: "row justify-content-between vmmargin" },
    ...
    r => {
      ...
      return /*#__PURE__*/React.createElement("div", { className: "noop" });
    })))));
...
function FullDial(props) {
  ...
  return /*#__PURE__*/(
    React.createElement(React.Fragment, null, /*#__PURE__*/
    React.createElement("div", { className: "col-md-6 shpadding" }, /*#__PURE__*/
    React.createElement(Panel, _extends({ elems: panel1 }, props))), /*#__PURE__*/

    React.createElement("div", { className: "col-md-6 shpadding" }, /*#__PURE__*/
    React.createElement(Panel, _extends({ elems: panel2 }, props)))));
...
function Title(props) {
  return /*#__PURE__*/(
    React.createElement("div", { className: "col-md-12 nopadding nomargin" }, /*#__PURE__*/
    React.createElement("h1", { className: "inblock title",
      style: { margin: "auto 5px auto 0px", color: "var(--main)" } }, /*#__PURE__*/
    React.createElement("strong", null, " ", /*#__PURE__*/React.createElement("i", { style: { color: "var(--main)" }, class: "fab fa-free-code-camp" }), " javaScript")), /*#__PURE__*/

    React.createElement("h2", { class: "nomargin inblock title",
      style: {
        margin: "auto 0px auto 5px",
        fontWeight: "lighter" } }, "calculator")));
...
function History(props) {
  ...
  return /*#__PURE__*/(
    React.createElement("ul", { className: "history darkgray absolute sfont", style: { zIndex: 40 } },
    ...
    (e, i) => {
      return /*#__PURE__*/(
        React.createElement("li", { style: { padding: "5px" } }, /*#__PURE__*/
        React.createElement("button", {
    ...
    React.createElement("li", null, "no previous operations")));
...
function DisplayErrors(props) {
  return /*#__PURE__*/(
    React.createElement("ul", { className: "nomargin nopadding ", style: { color: "red" } },

    props.err.map(
    (e, i) => /*#__PURE__*/
    React.createElement(React.Fragment, null, /*#__PURE__*/
    React.createElement("li", { className: "linemid hmargin error inblock sfont" },
    e), /*#__PURE__*/
...
function Input(props) {
  ...
  return /*#__PURE__*/(
    React.createElement("div", { className: "result", style: { overflow: "visible" } }, /*#__PURE__*/
    React.createElement("div", { className: "calc gray mfont" }, /*#__PURE__*/
    React.createElement("div", { className: "mid inblock text-left", style: { verticalAlign: "top" } }, /*#__PURE__*/
    React.createElement("div", { className: "linemid inblock relative" }, /*#__PURE__*/
    React.createElement("button", {
      className:
      showHis ?
    ...
    React.createElement("span", { className: "linemid" }, "|"), /*#__PURE__*/
    React.createElement("button", {
      className: props.radians ? button + " selected" : button,
      onClick: props.changeMode }, "Radians"), /*#__PURE__*/


    React.createElement("span", { className: "linemid" }, "|"), /*#__PURE__*/
    React.createElement("button", {
      className: props.radians ? button : button + " selected",
      onClick: props.changeMode }, "Degrees")), /*#__PURE__*/



    React.createElement("div", { className: "mid inblock", style: { overflow: "hidden" } },

    prev ?
    `ans = ${prev}` :
    "no previous operations")), /*#__PURE__*/
    ...
    props.errors.length > 0 ? /*#__PURE__*/
    React.createElement(DisplayErrors, { err: props.errors }) :
    ""))));
...
class Calculator extends React.Component {
  ...
  clickHandler(e) {
    ...
    if (control[code])
    triggerKey(input, code, "keydown");else
  ...
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement("div", { className: "col-md-10 col-lg-8 col-xl-6 col-sm-10 col-xs-12" }, /*#__PURE__*/
      React.createElement(Title, null), /*#__PURE__*/
      React.createElement("div", { className: "calculator row" }, /*#__PURE__*/
      React.createElement("div", { className: "container-fluid calculator col-md-12", style: { padding: "5px" } }, /*#__PURE__*/
      ...
      React.createElement(Input, {
        ...
        first: this.state.first })), /*#__PURE__*/

      React.createElement("div", { className: "row vmargin justify-content-end" }, /*#__PURE__*/
      React.createElement(FullDial, { handler: this.clickHandler })))))));
