...
function SelectData({ current, handler }) {
  ...
  return /*#__PURE__*/(
    React.createElement("ul", { className: "option-set" },
    ...
    React.createElement("li", { className:
      ...
      style: { width: "33.333334%" } }, /*#__PURE__*/
    React.createElement("button", { handler: e.name,
      className: "obutton",
      onClick: change },
    e.display)))));
...
class App extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/(
      ...
      React.createElement("div", { class: "col-md-12 col-lg-12 col-xl-9 dark-bg", style: { padding: "0" } }, /*#__PURE__*/
      React.createElement("h2", { class: "title", id: "title" },
      title, /*#__PURE__*/
      React.createElement("div", { id: "description", style: { fontSize: "18px", fontWeight: 200 } },
      sub)), /*#__PURE__*/


      React.createElement(SelectData, { handler: this.handleData,
        current: hand.name }))), /*#__PURE__*/


      React.createElement("div", { className: "row justify-content-center", style: { marginTop: "20px" } }, /*#__PURE__*/
      React.createElement("div", { class: "col-md-12 col-lg-12 col-xl-10" },

      this.state.loading ? /*#__PURE__*/
      React.createElement("h5", { style: { padding: "15px", textAlign: "center" } }, "Cargando...") :
      "", /*#__PURE__*/
